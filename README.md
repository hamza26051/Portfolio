...
Description:
Life Mirror is a Flask-based AI application that provides comprehensive personal analysis from a single selfie. It integrates facial, fashion, and posture analysis to generate detailed insights for personal improvement.  
...
- Automated encoding and scaling without external dependencies  
- Built TensorFlow-based models for classification and regression tasks  
